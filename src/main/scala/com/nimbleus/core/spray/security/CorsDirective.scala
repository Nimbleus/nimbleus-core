...
/**
 * This trait allows routes to be processed from a different than
 * what a browser we page was served from.
 *
 * CORS (cross-origin resource sharing)
 *
 * ref: https://gist.github.com/pcting/2e65c36f868c5cee7d6a
 *
 * User: cstewart
 */
trait CorsDirective {
